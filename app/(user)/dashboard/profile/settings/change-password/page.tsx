...
export default function ChangePasswordPage() {
  ...
  const onSubmit = async (values: ChangePasswordData) => {
    ...
    try {
      ...
      reset();
      setTimeout(() => router.push("/dashboard/profile/settings"), 1500);
    } catch {
    ...
    <>
      ...
      <div className="chpw-field-group">
        ...
        {errors.currentPassword && (
          <p className="chpw-err-msg">{errors.currentPassword.message}</p>
        )}
      </div>
      ...
      <div className="chpw-field-group">
        ...
        {errors.confirmPassword && (
          <p className="chpw-err-msg">{errors.confirmPassword.message}</p>
        )}
      </div>
    </>
  );
    ...
    <div className="chpw-root">
      ...
      <div className="chpw-mobile">
        ...
        <div className="chpw-mobile-body">
          ...
          {/* Fields card — matches your app's card style */}
          ...
          {/* Purple submit button — uses your auth-btn class */}
          <button
            type="button"
          ...
          >
            {isLoading ? (
              <>
                <span className="chpw-spinner" /> Changing Password...
              </>
            ) : (
              "Change Password"
            )}
          ...
          <p className="chpw-forgot-text">
            ...
            <button
              ...
              onClick={() =>
                router.push("/dashboard/profile/settings/reset-password")
              }
            >
              Reset it
            </button>
      ...
      <div className="chpw-desktop">
        {/* Desktop header — matches profile/settings header */}
