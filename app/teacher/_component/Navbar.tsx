  ...
  return (
    <>
      ...
      <nav className="mobile-bottom-nav">
        <button
          className={`mobile-nav-item ${isActive("/teacher/dashboard") ? "active" : ""}`}
          onClick={() => router.push("/teacher/dashboard")}
        >
          <svg
            width="24"
        ...
        <button
          className={`mobile-nav-item ${isActive("/teacher/dashboard/calendar") ? "active" : ""}`}
          onClick={() => router.push("/teacher/dashboard/calendar")}
        >
          <svg
            width="24"
            height="24"
        ...
        <button
          className={`mobile-nav-item ${isActive("/teacher/dashboard/profile") ? "active" : ""}`}
