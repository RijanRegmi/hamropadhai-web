...
function getSubjectColor(s: string) {
  return SUBJECT_COLORS[s] || "#6366f1";
}
...
export default function TeacherCalendarPage() {
  ...
  const fetchData = async () => {
    try {
      ...
      const map: DayEvents = {};
      deduped.forEach((a) => {
        const k = toDateKey(new Date(a.dueDate));
        if (!map[k]) map[k] = [];
        map[k].push(a);
      });
      setDayEvents(map);
    ...
    <div className="cal-page">
      ...
      <main className="cal-content">
        <div className="cal-back-row">
          <BackButton backUrl="/teacher/dashboard" />
        </div>
        ...
        <div className="cal-stats-row">
          ...
          <div className="cal-stat-card">
            ...
            <div>
              <p className="cal-stat-label">My Assignments</p>
              <p className="cal-stat-value">
              ...
              <div className="cal-grid">
                ...
                {Array.from({ length: daysInMonth }).map((_, i) => {
                  ...
                  return (
                    <div
                      key={day}
                      className={`cal-cell ${isToday(day) ? "cal-cell--today" : ""} ${isSelected(day) ? "cal-cell--selected" : ""} ${hasEvent ? "cal-cell--has-event" : ""}`}
                      onClick={() =>
                        ...
                        <div className="cal-dots">
                          {events.slice(0, 3).map((e, idx) => (
                            <span
                              key={idx}
                              className="cal-dot"
                              style={{ background: getSubjectColor(e.subject) }}
                            />
                          ))}
                          {events.length > 3 && (
                  ...
                  {selectedEvents.map((a) => {
                    ...
                    return (
                      <div
                        ...
                        onClick={() =>
                          router.push(
                            `/teacher/dashboard/assignments/viewandgrade/${a._id}`,
                          )
                        }
                      >
                        <div className="cal-event-header">
                          ...
                          <span className="cal-event-class-badge">
                            {a.classId}-{a.sectionId}
                          </span>
                          {isPast && (
                            <span className="cal-event-past">Past</span>
                          )}
                        </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="cal-upcoming-info">
                          ...
                          <p className="cal-upcoming-subject">
                            {a.subject} · {a.classId}-{a.sectionId}
                          </p>
                        </div>
                        <div
