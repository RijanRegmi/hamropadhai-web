...
export default function VerifyResetCodePage() {
  ...
  useEffect(() => {
    if (!email)
      window.location.href =
        "/teacher/dashboard/profile/settings/reset-password";
  }, [email]);
  ...
  const verify = async (codeToVerify = code) => {
    ...
    try {
      ...
      window.location.href = `/teacher/dashboard/profile/settings/reset-password/new-password?email=${encodeURIComponent(email)}&code=${encodeURIComponent(codeToVerify)}`;
    } catch {
